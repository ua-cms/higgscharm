...
histograms = {
    "z_mass": hda.hist.Hist(z_mass_axis, syst_axis, hist.storage.Weight()),
    "mu1_pt": hda.hist.Hist(mu1_pt_axis, syst_axis, hist.storage.Weight()),
    "mu2_pt": hda.hist.Hist(mu2_pt_axis, syst_axis, hist.storage.Weight()),
    "cjet_pt": hda.hist.Hist(jet_pt_axis, syst_axis, hist.storage.Weight()),
    "cjet_eta": hda.hist.Hist(jet_eta_axis, syst_axis, hist.storage.Weight()),
    "cjet_phi": hda.hist.Hist(jet_phi_axis, syst_axis, hist.storage.Weight()),
    "cjet_z_deltaphi": hda.hist.Hist(deltaphi_axis, syst_axis, hist.storage.Weight()),
    "njets": hda.hist.Hist(n_jets_axis, syst_axis, hist.storage.Weight()),
    "npvs": hda.hist.Hist(n_vertices_axis, syst_axis, hist.storage.Weight()),
}